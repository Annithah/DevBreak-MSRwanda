...
function Homepage() {
    ...
    return (
        <>
            <nav>
                <h1>MediHub Rwanda</h1>
                
                {/* Home link - scrolls to top */}
                <a href="#home" className="link" onClick={(e) => {
                    e.preventDefault();
                    window.scrollTo({ top: 0, behavior: 'smooth' });
                }}>Home</a><span></span>
                
                {/* About Us link */}
                <a href="#about" className="link" onClick={(e) => scrollToSection(e, 'about')}>About Us</a><span></span>
                
                {/* Services link */}
                <a href="#service" className="link" onClick={(e) => scrollToSection(e, 'service')}>Services</a><span></span>
                
                {/* How it Works link */}
                <a href="#how-it-works" className="link" onClick={(e) => scrollToSection(e, 'how-it-works')}>How it Works</a><span></span>
                
                {/* Contact link */}
                <a href="#contact" className="link" onClick={(e) => scrollToSection(e, 'contact')}>Contact</a><span></span>
                
                {/* These will still use React Router for navigation */}
                <Link to={"/continue-as"} className="link">Register</Link><span></span>
                <Link to={"/login"} className="link">Login</Link><span></span>
            </nav>

            <div className="welcomingpage" id="home">
                <section className="welcome">
                    <p className="wellocome">
                        Access your medical services online anytime, anywhere
                    </p>
                    <Link to={"/continue-as"} className="link">Visit Here</Link><span></span>
                </section>
                <br /><br />
            </div>
                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-column">
                            ...
                            <ul className="footer-links">
                                ...
                                <li><a href="#service" onClick={(e) => scrollToSection(e, 'service')}>Services</a></li>
